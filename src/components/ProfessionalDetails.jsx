        ...
        <Grid container>
          <Grid item xs={2}>
            ...
            >
              ...
              >
                <Tab label="Job Information" {...a11yProps(0)} />
                <Tab label="Email / Other Access" {...a11yProps(1)} />
                <Tab label="Assignment / Reporting" {...a11yProps(2)} />
              </Tabs>
            </Box>
          </Grid>
          <Grid item xs={8}>
            ...
            <TabPanel value={value} index={1}>
              ...
              <span className={animationClass2}>
                <EmailandOtherAccessDetails title="Email / Other Access" />
              </span>
            </TabPanel>
            <TabPanel value={value} index={2}>
              ...
              <span className={animationClass2}>
                <AssignmentandReportingInfo title="Assignment / Reporting" />
              </span>
            </TabPanel>
          </Grid>
        </Grid>
